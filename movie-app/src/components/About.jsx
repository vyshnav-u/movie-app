        ...
        <div>
            <div className='py-[100px]'>
                ...
                <div className='flex items-center justify-between relative px-9 p-9'>
                    <h1 className=' hidden lg:block bebas md:text-[200px] max-w-[800px] md:leading-[150px] text-white'>WATCH THE BEST SHOWS*</h1>
                    ...
                    <img className='h-[250px] md:h-[400px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20' src={heart} alt="" />
                </div>
